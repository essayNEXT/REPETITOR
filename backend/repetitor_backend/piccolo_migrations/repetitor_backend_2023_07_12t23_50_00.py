...
async def forwards():
    ...
    async def run():
        await RawTable.raw(
            """ insert into customer (id, tlg_user_id, tlg_first_name, tlg_language, is_active) 
            VALUES 
        ('00000000-0000-0000-0000-000000000000',  '0', 'microsoft_translate', 'en', true),
        ('00000000-0000-0000-0000-000000000001',  '1', 'google_translate', 'en', true);
