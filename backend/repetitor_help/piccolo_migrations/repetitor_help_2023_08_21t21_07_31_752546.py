...
async def forwards():
    manager = MigrationManager(
        migration_id=ID, app_name="repetitor_help", description=DESCRIPTION
    )
    ...
    manager.add_column(
        ...
        db_column_name="total_impressions",
    ...
    manager.add_column(
        table_class_name="Help",
        tablename="help",
        column_name="positive_feedback",
        db_column_name="positive_feedback",
        column_class_name="Integer",
        column_class=Integer,
        params={
            "default": 0,
    ...
    manager.add_column(
        table_class_name="Help",
        tablename="help",
        column_name="negative_feedback",
        db_column_name="negative_feedback",
        column_class_name="Integer",
        column_class=Integer,
        params={
            "default": 0,
    ...
    manager.add_column(
        table_class_name="Help",
        tablename="help",
        column_name="auto_translation",
        db_column_name="auto_translation",
